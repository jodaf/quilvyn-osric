...
OSRIC.FEATURES = {
  ...
  'Alert Against Surprise':
    'Section=combat Note="Surprised 1in6; surprises 3in6"',
  'Assassination':
    'Section=combat ' +
  ...
  'Cure Disease':
    'Section=magic ' +
    'Note="May use <i>Cure Disease</i> effects %{(levels.Paladin+4)//5<?3}/wk"',
  'Damage Bonus':
    'Section=combat ' +
  ...
  'Detect Evil':
    'Section=magic Note="May use R60\' <i>Detect Evil</i> effects at will"',
  'Discriminating':
    'Section=feature Note="Must not associate w/non-good characters"',
  'Disguise':
    'Section=feature Note="May disguise self w/a 92%+ chance of success"',
  ...
  'Eldritch Power':
    'Section=magic ' +
    'Note="May use <i>Enchant An Item</i> to create magical items"',
  ...
  'Non-Materialist':
    'Section=feature Note="May own at most 10 magic items, including 1 armor suit and 1 shield"',
  'Philanthropist':
    'Section=feature ' +
  ...
  'Tracking':
    'Section=feature ' +
    'Note="May track creatures w/a 90% chance of success in rural settings and a 65%+ chance of success in urban or dungeon settings"',
  'Travel Light':
  ...
  'Stealthy':
    'Section=combat ' +
    'Note="4in6 chance to surprise when traveling quietly; 2in6 chance when opening doors"',
  'Sword Precision':
...
OSRIC.SPELLS = {
  ...
  'Affect Normal Fires':
    ...
    'Level=M1 ' +
    'Description=' +
      '"R%{lvl*5}\' Changes the size of a fire of up to 1.5\' radius from a candle flame to a 1.5\' radius for %{lvl} rd"',
  'Airy Water':
    'School=Alteration ' +
    'Level=M5 ' +
  ...
  'Animal Growth':
    ...
    'Level=D5,M5 ' +
    'Description=' +
      '"R%{slvl==\'D5\'?80:60}\' Doubles (Reverse halves) the size, HD, and damage of 8 animals for %{slvl==\'D5\'?lvl*2:lvl} rd"',
  'Animal Summoning I':
    'School=Conjuration ' +
    'Level=D4 ' +
  ...
  'Blade Barrier':
    ...
    'Level=C6 ' +
    'Description=' +
      '"R30\' Creates a 10\' radius blade wall that inflicts 8d8 HP for %{lvl*3} rd"',
  'Bless':
    'School=Conjuration ' +
    'Level=C1 ' +
    'Description=' +
  ...
  'Clairaudience':
    'School=Divination ' +
    'Level=M3 ' +
    'Description="Allows self to hear a known location for %{lvl} rd"',
  'Clairvoyance':
    'School=Divination ' +
    'Level=M3 ' +
    'Description="Allows self to see a known location for %{lvl} rd"',
  'Clenched Fist':
    'School=Evocation ' +
    'Level=M8 ' +
    'Description=' +
  ...
  'Conjure Animals':
    ...
    'Level=C6,I6 ' +
    'Description=' +
      '"R30\' Summons %{lvl} HD of animals to fight for %{slvl==\'C6\'?lvl*2:lvl} rd"',
  ...
  'Contact Other Plane':
    ...
    'Level=M5 ' +
    'Description=' +
      '"Allows self to ask %{lvl//2} questions of an extraplanar entity"',
  'Continual Darkness':
    'School=Alteration ' +
    'Level=I3 ' +
  ...
  'Create Water':
    ...
    'Level=C1,D2 ' +
    'Description=' +
      '"R10\' Creates (Reverse destroys) %{slvl==\'C1\'?lvl*4+\' gallons\':(lvl+\\"\' cu\\")} of potable water"',
  'Creeping Doom':
    'School=Conjuration ' +
    'Level=D7 ' +
    'Description=' +
  ...
  'Detect Evil':
    ...
    'Level=C1,M2 ' +
    'Description=' +
      '"Self discerns evil auras (Reverse good) in a 10\'x%{slvl==\'C1\'?120:60}\' path for %{lvl*5+(slvl==\'C1\'?10:0)} rd"',
  'Detect Illusion':
    'School=Divination ' +
    'Level=I1 ' +
    'Description=' +
  ...
  'Detect Magic':
    ...
    'Level=C1,D1,I2,M1 ' +
    'Description=' +
      '"Self discerns magical auras in a 10\'x%{slvl==\'C1\'?30:slvl==\'D1\'?40:60}\' path for %{slvl==\'C1\'?\'1 tn\':slvl==\'D1\'?\'12 rd\':(lvl*2+\' rd\')}"',
  ...
  'ESP':
    ...
    'Level=M2 ' +
    'Description=' +
      '"R%{lvl*5<?90}\' Allows self to hear surface thoughts for %{lvl} rd"',
  'Earthquake':
    'School=Alteration ' +
    'Level=C7 ' +
    'Description=' +
  ...
  'Extension I':
    ...
    'Level=M4 ' +
    'Description=' +
      '"Increases the duration of an existing level 1-3 spell by 50%"',
  'Extension II':
    'School=Alteration ' +
    'Level=M5 ' +
    'Description=' +
      '"Increases the duration of an existing level 1-4 spell by 50%"',
  'Extension III':
    'School=Alteration ' +
    'Level=M6 ' +
    'Description=' +
      '"Increases the duration of an existing level 1-3 spell by 100% or a level 4-5 spell by 50%"',
  'Faerie Fire':
    'School=Alteration ' +
    'Level=D1 ' +
    'Description=' +
  ...
  'Find The Path':
    ...
    'Level=C6 ' +
    'Description=' +
      '"Touched discerns the shortest route into and out of a chosen location for %{lvl} tn (Reverse causes indirection)"',
  'Find Traps':
    'School=Divination ' +
    'Level=C2 ' +
  ...
  'Fire Shield':
    ...
    'Level=M4 ' +
    'Description=' +
      '"Self gains +2 saves and half damage vs. fire (Reverse cold), and suffers dbl damage vs. cold (Reverse fire), for %{lvl+2} rd"',
  'Fire Storm':
    'School=Evocation ' +
    'Level=D7 ' +
    'Description=' +
  ...
  'Floating Disk':
    ...
    'Level=M1 ' +
    'Description=' +
      '"R20\' 3\' diameter x 1\\" thick force disk follows self and holds %{lvl*100} lbs for %{lvl+3} tn"',
  'Fly':
    'School=Alteration ' +
    'Level=M3 ' +
    'Description="Allows touched to fly 120\'/rd for 1d6+%{lvl*6} tn"',
  'Fog Cloud':
    'School=Alteration ' +
    'Level=I2 ' +
    'Description=' +
      '"R10\' Creates fog in a 40\'x20\'x20\' area that obscures vision and moves away 10\'/rd for %{lvl+4} rd"',
  "Fool's Gold":
    'School=Alteration ' +
    'Level=M2 ' +
    'Description=' +
  ...
  'Geas':
    ...
    'Level=M6 ' +
    'Description=' +
      '"Touched sickens and dies in 1d4 wk unless a specified quest is pursued"',
  'Glass-steel':
    'School=Alteration ' +
    'Level=M8 ' +
  ...
  'Globe Of Invulnerability':
    'School=Abjuration ' +
    'Level=M6 ' +
    'Description="5\' radius blocks level 1-4 spells for %{lvl} rd"',
  'Glyph Of Warding':
    'School=Abjuration ' +
    'Level=C3 ' +
    'Description=' +
      '"%{lvl*25}\' sq inflicts %{lvl*2} HP (Save half) when next touched w/out speaking the glyph name"',
  'Grasping Hand':
    'School=Evocation ' +
    'Level=M7 ' +
    'Description=' +
  ...
  'Hallucinatory Terrain':
    ...
    'Level=I3,M4 ' +
    'Description=' +
      '"R%{lvl*20+(slvl==\'I3\'?20:0)}\' %{lvl*10+(slvl==\'I3\'?40:0)}\' sq mimics a different terrain until touched"',
  'Haste':
    'School=Alteration ' +
    'Level=M3 ' +
    'Description=' +
  ...
  'Hold Person':
    ...
    'Level=C2,M3 ' +
    'Description=' +
      '"R%{slvl==\'C2\'?60:120}\' Immobilizes 1-%{slvl==\'C2\'?3:4} medium targets for %{slvl==\'C2\'?lvl+4:(lvl*2)} rd (Save neg)"',
  'Hold Plant':
    'School=Enchantment ' +
    'Level=D4 ' +
    'Description=' +
      '"R80\' Immobilizes plants in 4-16 sq yd for %{lvl} rd (Save neg)"',
  'Hold Portal':
    'School=Alteration ' +
    'Level=M1 ' +
    'Description=' +
  ...
  'Identify':
    ...
    'Level=M1 ' +
    'Description=' +
      '"Allows self to determine any magical properties of touched w/in %{lvl} hr of discovery (%{lvl*5+15}% chance) (Save neg or mislead); requires rest afterward"',
  'Illusory Script':
    'School=Illusion ' +
    'Level=I3 ' +
    'Description=' +
      '"Obscured writing inflicts confusion for 5d4 rd (Save neg) on unauthorized readers"',
  'Imprisonment':
    'School=Abjuration ' +
    'Level=M9 ' +
    'Description="Safely traps touched creature underground (Reverse frees)"',
  ...
  'Insect Plague':
    ...
    'Level=C5,D5 ' +
    'Description=' +
      '"R%{slvl==\'D5\'?320:360}\' Stinging insects fill a %{slvl==\'D5\'?160:180}\' radius, inflicting 1 HP/rd for %{lvl} tn; creatures w/fewer than 2 HD flee, 3-4 HD check morale"',
  'Instant Summons':
    'School=Conjuration ' +
    'Level=M7 ' +
  ...
  'Jump':
    ...
    'Level=M1 ' +
    'Description=' +
      '"Allows touched to jump 30\' forward, 10\' back, or 10\' up %{(lvl+2)//3} times"',
  'Knock':
    'School=Alteration ' +
    'Level=M2 ' +
    'Description=' +
      '"R60\' Opens a stuck, barred, locked, or magically held door, chest, or shackle"',
  'Know Alignment':
    'School=Divination ' +
    'Level=C2 ' +
    'Description=' +
  ...
  'Levitate':
    ...
    'Level=M2 ' +
    'Description=' +
      '"R%{lvl*20}\' Allows self to move a %{lvl*100} lb target up and down 10\'/rd, or self 20\'/rd, for %{lvl} tn (Save neg)"',
  'Light':
    'School=Alteration ' +
    'Level=C1,I1,M1 ' +
    'Description=' +
      '"R%{slvl==\'C1\'?120:60}\' Target spot emits a 20\' radius light for %{lvl+(slvl==\'C1\'?6:0)} tn (Reverse darkness half duration)"',
  'Lightning Bolt':
    'School=Evocation ' +
    'Level=M3 ' +
    'Description=' +
  ...
  'Locate Object':
    ...
    'Level=C3,M2 ' +
    'Description=' +
      '"R%{slvl==\'C3\'?lvl*10+60:(lvl*20)}\' Self discerns location of a desired object for %{lvl} rd (Reverse obscures)"',
  'Locate Plants':
    'School=Divination ' +
    'Level=D2 ' +
  ...
  'Maze':
    ...
    'Level=I5,M8 ' +
    'Description=' +
      '"R%{lvl*5}\' Target becomes lost in an extradimensional maze for up to 2d4 tn, depending on Intelligence"',
  'Mending':
    'School=Alteration ' +
    'Level=M1 ' +
  ...
  'Message':
    ...
    'Level=M1 ' +
    'Description=' +
      '"R%{lvl*10+60}\' Allows self to hold a whispered dialogue w/target for %{lvl+5} seg"',
  'Meteor Swarm':
    'School=Evocation ' +
    'Level=M9 ' +
    'Description=' +
  ...
  'Minor Globe Of Invulnerability':
    'School=Abjuration ' +
    'Level=M4 ' +
    'Description="5\' radius blocks level 1-3 spells for %{lvl} rd"',
  'Mirror Image':
    'School=Illusion ' +
    'Level=I2,M2 ' +
    'Description=' +
  ...
  'Mnemonic Enhancer':
    ...
    'Level=M4 ' +
    'Description=' +
      '"Allows self to memorize +3 spell levels or to retain a just-cast spell of up to 3rd level for 1 dy"',
  'Monster Summoning I':
    'School=Conjuration ' +
    'Level=M3 ' +
    'Description=' +
  ...
  'Pass Plant':
    ...
    'Level=D5 ' +
    'Description=' +
      '"Allows self to teleport up to 600 yd between trees of the same species"',
  'Pass Without Trace':
    'School=Enchantment ' +
    'Level=D1 ' +
  ...
  'Phantasmal Force':
    ...
    'Level=I1,M3 ' +
    'Description=' +
      '"R%{lvl*10+(slvl==\'M3\'?80:60)}\' Creates a %{lvl*10+(slvl==\'M3\'?80:40)}\' sq illusion for conc or until struck (Save disbelieve)"',
  'Phantasmal Killer':
    'School=Illusion ' +
    'Level=I4 ' +
    'Description=' +
      '"R%{lvl*5}\' Creates a nightmare illusion that attacks target as a HD 4 creature, killing on a hit, for %{lvl} rd (Intelligence Save neg)"',
  'Phase Door':
    'School=Alteration ' +
    'Level=M7 ' +
    'Description="Allows self to pass twice through touched 10\' solid"',
  'Plane Shift':
    'School=Alteration ' +
    'Level=C5 ' +
  ...
  'Plant Door':
    ...
    'Level=D4 ' +
    'Description=' +
      '"Allows self to move effortlessly through vegetation for %{lvl} tn"',
  'Plant Growth':
    'School=Alteration ' +
    'Level=D3,M4 ' +
    'Description=' +
  ...
  'Polymorph Self':
    ...
    'Level=M4 ' +
    'Description=' +
      '"Allows self to transform into a different creature weighing up to 2000 lb 2/min for %{lvl*2} tn"',
  'Power Word, Blind':
    'School=Conjuration ' +
    'Level=M8 ' +
    'Description=' +
  ...
  'Produce Fire':
    ...
    'Level=D4 ' +
    'Description=' +
      '"R40\' Creates fire in a 60\' radius that inflicts 1d4 HP for 1 rd (Reverse extinguishes)"',
  'Produce Flame':
    'School=Alteration ' +
    'Level=D2 ' +
    'Description=' +
      '"R40\' Creates a flame that ignites combustibles and may be thrown to burn a 15\' radius for %{lvl*2} rd"',
  'Programmed Illusion':
    'School=Illusion ' +
    'Level=I6 ' +
    'Description=' +
  ...
  'Project Image':
    ...
    'Level=I5,M6 ' +
    'Description=' +
      '"R%{lvl*(slvl==\'I5\'?5:10)}\' Allows self to cast through an illusory double for %{lvl} rd"',
  'Protection From Evil':
    'School=Abjuration ' +
    'Level=C1,M1 ' +
    'Description=' +
  ...
  'Quest':
    ...
    'Level=C5 ' +
    'Description=' +
      '"R60\' Target suffers -1 saves each dy until a specified quest is pursued (Save neg)"',
  'Raise Dead':
    'School=Necromancy ' +
    'Level=C5 ' +
    'Description=' +
  ...
  'Reverse Gravity':
    'School=Alteration ' +
    'Level=M7 ' +
    'Description="R%{lvl*5}\' Items in a 30\' sq area fall upward for 1 sec"',
  'Rope Trick':
    'School=Alteration ' +
    'Level=I3,M2 ' +
    'Description=' +
  ...
  'Secret Chest':
    ...
    'Level=M5 ' +
    'Description=' +
      '"Allows self to summon a 12\' cu aethereal chest at will for 60 dy"',
  'Shades':
    'School=Illusion ' +
    'Level=I6 ' +
    'Description=' +
  ...
  'Shape Change':
    'School=Alteration ' +
    'Level=M9 ' +
    'Description="Allows self to polymorph freely for %{lvl} tn"',
  'Shatter':
    'School=Alteration ' +
    'Level=M2 ' +
    'Description=' +
  ...
  'Speak With Animals':
    ...
    'Level=C2,D1 ' +
    'Description=' +
      '"R%{slvl==\'D1\'?40:30}\' Allows self to converse w/%{slvl==\'D1\'?\'chosen type of\':\'target\'} animal for %{lvl*2} rd"',
  'Speak With Dead':
    'School=Necromancy ' +
    'Level=C3 ' +
    'Description=' +
      '"R10\' Allows self to ask a corpse %{lvl<7?2:lvl<9?3:lvl<13?4:lvl<16?5:lvl<21?6:7} questions"',
  'Speak With Monsters':
    'School=Alteration ' +
    'Level=C6 ' +
    'Description=' +
      '"R30\' Allows self to converse w/intelligent creatures for %{lvl} rd"',
  'Speak With Plants':
    'School=Alteration ' +
    'Level=C4,D4 ' +
    'Description=' +
      '"R%{slvl==\'D4\'?40:30}\' Allows self to converse w/plants for %{lvl*(slvl==\'D4\'?2:1)} rd"',
  'Spectral Force':
    'School=Illusion ' +
    'Level=I3 ' +
    'Description=' +
  ...
  'Spider Climb':
    ...
    'Level=M1 ' +
    'Description=' +
      '"Allows touched to move 30\'/rd on walls and ceilings for %{lvl+1} rd"',
  'Spirit-Rack':
    'School=Abjuration ' +
    'Level=M6 ' +
    'Description=' +
  ...
  'Spiritual Weapon':
    ...
    'Level=C2 ' +
    'Description=' +
      '"R30\' Allows self to attack w/a magical force for conc up to %{lvl} rd"',
  'Statue':
    'School=Alteration ' +
    'Level=M7 ' +
    'Description="Allows touched to become stone at will for %{lvl} hr"',
  'Sticks To Snakes':
    'School=Alteration ' +
    'Level=C4,D5 ' +
    'Description=' +
      '"R%{slvl==\'D5\'?40:30}\' Transforms %{lvl} sticks in a %{slvl==\'D5\'?\\"5\' radius\\":\\"10\' cu\\"} to snakes (%{lvl*5}% venomous) (Reverse transforms snakes to sticks) for %{lvl*2} rd"',
  'Stinking Cloud':
    'School=Evocation ' +
    'Level=M2 ' +
    'Description=' +
  ...
  'Stone Shape':
    'School=Alteration ' +
    'Level=D3,M5 ' +
    'Description="Reshapes %{lvl+(slvl==\'D3\'?3:0)}\' cu of stone"',
  'Stone Tell':
    'School=Divination ' +
    'Level=C6 ' +
    'Description="Allows self to converse w/3\' cu of rock for 1 tn"',
  'Stone To Flesh':
    'School=Alteration ' +
    'Level=M6 ' +
    'Description=' +
      '"R%{lvl*10}\' Restores stoned creature (system shock required) or transforms %{lvl*9}\' cu stone to flesh (Reverse transforms flesh to stone (Save neg))"',
  'Strength':
    'School=Alteration ' +
    'Level=M2 ' +
    'Description=' +
  ...
  'Suggestion':
    ...
    'Level=I3,M3 ' +
    'Description=' +
      '"R30\' Target follows reasonable suggestions for %{slvl==\'I3\'?lvl*4+4+\' tn\':(lvl+1+\' hr\')} (Save neg)"',
  'Summon Insects':
    'School=Conjuration ' +
    'Level=D3 ' +
    'Description=' +
  ...
  'Symbol':
    ...
    'Level=C7,M8 ' +
    'Description=' +
      '"Glowing symbol causes death, discord for 5d4 rd, fear (Save -4 neg), hopelessness for 3d4 tn, insanity, pain for 2d10 tn, sleep for 4d4+1 tn, or stunning for 3d4 rd"',
  'Symbol C7':
    'Description=' +
  ...
  'Telekinesis':
    ...
    'Level=M5 ' +
    'Description=' +
      '"R%{lvl*10}\' Self may move a target object weighing up to %{lvl*25} lb for %{lvl+2} rd"',
  'Teleport':
    'School=Alteration ' +
    'Level=M5 ' +
    'Description=' +
  ...
  'Time Stop':
    ...
    'Level=M9 ' +
    'Description=' +
      '"Allows self to perform extra actions in a 15\' radius for 1d8+%{lvl//2} seg"',
  'Tiny Hut':
    'School=Alteration ' +
    'Level=M3 ' +
  ...
  'Tongues':
    ...
    'Level=C4,M3 ' +
    'Description=' +
      '"R30\' Allows self to converse in any language (Reverse muddles) for %{slvl==\'M3\'?lvl+\' rd\':\'1 tn\'}"',
  'Transformation':
    'School=Alteration ' +
    'Level=M6 ' +
    'Description=' +
  ...
  'Transmute Metal To Wood':
    'School=Alteration ' +
    'Level=D7 ' +
    'Description="R80\' Transforms target %{lvl*8} lb metal object into wood"',
  'Transmute Rock To Mud':
    'School=Alteration ' +
    'Level=D5,M5 ' +
    'Description=' +
      '"R%{slvl==\'M5\'?lvl*10:160}\' Transforms %{lvl*20}\' cu rock into mud (Reverse transforms mud into rock)"',
  'Transport Via Plants':
    'School=Alteration ' +
    'Level=D6 ' +
    'Description=' +
      '"Allows self to teleport any distance between plants of the same species"',
  'Trap The Soul':
    'School=Conjuration ' +
    'Level=M8 ' +
  ...
  'Tree':
    'School=Alteration ' +
    'Level=D3 ' +
    'Description="Transforms self into a tree for %{lvl+6} tn"',
  'Trip':
    'School=Enchantment ' +
    'Level=D2 ' +
    'Description="Causes touched 10\' object to trip passers (Save neg) for %{lvl} tn"',
  'True Seeing':
    'School=Divination ' +
    'Level=C5 ' +
    'Description=' +
     '"Allows touched to discern deceptions and alignment auras in a 120\' radius for %{lvl} rd (Reverse obscures)"',
  'True Sight':
    'School=Divination ' +
    'Level=I6 ' +
    'Description=' +
      '"Allows touched to discern deceptions in a 60\' radius for %{lvl} rd"',
  'Turn Wood':
    'School=Alteration ' +
    'Level=D6 ' +
  ...
  'Ventriloquism':
    ...
    'Level=I2,M1 ' +
    'Description=' +
      '"R%{lvl*10<?(slvl==\'M1\'?60:90)}\' Allows self to throw voice for %{lvl+(slvl==\'M1\'?2:4)} rd ((Intelligence - 12) * 10% disbelieve)"',
  'Vision':
    'School=Divination ' +
    'Level=I7 ' +
    'Description=' +
      '"Allows self to seek the answer to a question; may suffer geas"',
  'Wall Of Fire':
    'School=Evocation ' +
    'Level=D5,M4 ' +
    'Description=' +
  ...
  'Warp Wood':
    'School=Alteration ' +
    'Level=D2 ' +
    'Description="R%{lvl*10}\' Bends a %{lvl}\\"x%{lvl*15}\\" wooden item"',
  'Water Breathing':
    'School=Alteration ' +
    'Level=D3,M3 ' +
    'Description=' +
      '"Allows touched to breathe water (Reverse breathe air) for %{lvl+(slvl==\'M3\'?\' rd\':\' hr\')}"',
  'Weather Summoning':
    'School=Conjuration ' +
    'Level=D6 ' +
    'Description=' +
  ...
  'Web':
    ...
    'Level=M2 ' +
    'Description=' +
      '"R%{lvl*5}\' Creates an 80\' cu sticky web that spans anchor points for %{lvl*2} tn"',
  'Wind Walk':
    'School=Alteration ' +
    'Level=C7 ' +
    'Description=' +
      '"Makes self and %{lvl//8} others insubstantial; may travel 600\'/tn for %{lvl} hr"',
  'Wish':
    'School=Conjuration ' +
    'Level=M9 ' +
  ...
  'Wizard Eye':
    ...
    'Level=M4 ' +
    'Description=' +
      '"Allows self to see through and move 30\'/rd an invisible eye w/600\' vision and 100\' infravision for %{lvl} rd"',
  'Wizard Lock':
    'School=Alteration ' +
    'Level=M2 ' +
    'Description="Holds shut a touched door, gate, or window"',
  'Word Of Recall':
    'School=Alteration ' +
    'Level=C6 ' +
    'Description="Returns self to a designated place"',
  'Write':
    'School=Evocation ' +
    'Level=M1 ' +
    'Description=' +
      '"Allows self to copy spells that are too powerful to learn (Save vs. spell; fail inflicts 1d4 HP/spell level and unconsciousness) for %{lvl} hr"'
};
...
OSRIC.spellRules = function(
  ...
  description = description.replaceAll('slvl', '"' + casterGroup + level + '"');
  SRD35.spellRules
...
OSRIC.weaponRules = function(rules, name, category, damage, range) {
  ...
  rules.defineRule(prefix + 'AttackModifier',
    ...
    'combatNotes.doubleSpecialization', '+', 'source=="' + name + '" ? 2 : null'
  );
  if(name.match(/Bow/)) {
    rules.defineRule
  ...
  rules.defineRule(prefix + 'DamageModifier',
    ...
    'combatNotes.doubleSpecialization', '+', 'source=="' + name + '" ? 1 : null'
  );
